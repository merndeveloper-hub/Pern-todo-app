...
const updateDescription = async (e) => {
    ...
    try {
        ...
        const response = await fetch(`http://lcoalhost:5000/todos/${todo.todo_id}`, {
            method: "PUT",
    ...
    return (
    <Fragment>
<button type='buttton' className='btn btn-warning' data-toggle="modal" data-target={`#id${todo.todo_id}`}>
    Edit
</button>
...
<div className='modal-dialog'>
  <div className='modal-content'>
   <div className='modal-header'>
     <h4 className='modal-button'>Edit Todo</h4>
